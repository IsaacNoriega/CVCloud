...
export function HomeView({ onSelectTemplate }: HomeViewProps) {
  ...
  return (
    <div className="flex-1 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="mb-4">Plantillas de Currículum</h1>
          <p className="text-muted-foreground">
            Selecciona un diseño profesional y comienza a crear tu currículum
          </p>
        </div>
